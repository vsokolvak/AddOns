...
function LootMaster:OnInitialize()
    ...
    self.RESPONSE = {
        ...
        { ["CODE"]      = "INIT",           ["SORT"] =  200,  ["COLOR"] = {1,0,0},        ["TEXT"] = 'EP/GP Lootmaster не встановлено' },
        { ["CODE"]      = "WAIT",           ["SORT"] =  300,  ["COLOR"] = {1,0.5,0},      ["TEXT"] = 'Робить вибір, будь ласка зачекайте' },
        { ["CODE"]      = "TIMEOUT",        ["SORT"] =  400,  ["COLOR"] = {1,0,1},        ["TEXT"] = 'Кандидат не зробив вибір' },
        ...
        { ["CODE"]      = "PASS",           ["SORT"] = 1000,  ["COLOR"] = {0.6,0.6,0.6},  ["TEXT"] = 'На розпил' },
    ...
    self.LOOTTYPE = {
        ...
        { ["CODE"]      = "DISENCHANT",     ["TEXT"] = '%s отримав %s на розпил%4$s.' },
        { ["CODE"]      = "BANK",           ["TEXT"] = '%s отримав %s в банк%4$s.' }
    }
